...
public class SellerListController implements Initializable, DataChangeListener {
	...
	@FXML
	private TableColumn<Seller, Seller> tableColumnEDIT = new TableColumn<Seller, Seller>();

	@FXML
	private TableColumn<Seller, Seller> tableColumnREMOVE = new TableColumn<Seller, Seller>();
